...
\chapter{Model Calibration}
	...
	\textbf{Assignment}: Use this experimental data to calibrate the draining portion of the model.
...
\chapter{Exercises}
	...
	\section{Rectangular Prism}
		Create a model for the filling of a water container where the container was a rectangular prism instead of a cylinder, where the radius increases by 1 cm for every 2 cm increase in height?
	...
	\section{Cone}
		...
		\begin{figure}[h!]
			\begin{center}
				\includegraphics[width=0.75\textwidth]{cone-rh.pdf}
				\caption{Comparison of measured (blue) and modeled (red) data. This version of the model uses $Q=10$ cm$^3$/s.}
			\end{center}
		\end{figure}
